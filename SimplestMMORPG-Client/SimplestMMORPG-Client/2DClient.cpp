...
void ProcessPacket(char *ptr)
{
	...
	//case SC_LOGIN_OK:
	//{
	//	ScPacketLogginOk *packet = 
	//		reinterpret_cast<ScPacketLogginOk *>(ptr);
	//	g_myid = packet->id;
	//}

	//case SC_PUT_PLAYER:
	//{
	//	ScPacketPutPlayer *my_packet = reinterpret_cast<ScPacketPutPlayer *>(ptr);
	//	int id = my_packet->id;
	...
	//case SC_MOVEPLAYER:
	//{
	//	ScPacketMovePlayer *my_packet = reinterpret_cast<ScPacketMovePlayer *>(ptr);
	...
	//{
	//	ScPacketRemovePlayer *my_packet = reinterpret_cast<ScPacketRemovePlayer *>(ptr);
	//	int other_id = my_packet->id;
	//	if (other_id == g_myid) {
	//		player.attr &= ~BOB_ATTR_VISIBLE;
	//	}
	...
	LPARAM lparam)
{
	...
	case WM_KEYDOWN: {
		...
		/*CsPacketUp *my_packet = reinterpret_cast<CsPacketUp *>(send_buffer);
